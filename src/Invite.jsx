  ...
  return (<>
    <div className='invite-main' ref={inviteRef}>
      ...
      <div className='invite-sectioninfo'>
        ...
        <p className='invite-p'>Будем благодарны, если вы воздержитесь от криков "Горько" на празднике, ведь поцелуй — это знак выражения чувств, он не может быть по заказу.</p>
